...
describe('express-standard-schema-validation with ArkType >= 2.0.0-rc', function() {
  let mod
  ...
  describe('#headers validation', function() {
    it('should successfully validate headers using ArkType', function(done) {
      const validator = mod.createValidator()
      const schema = type({
        'x-api-key': 'string',
        'content-type?': 'string'
  ...
  describe('ArkType-specific features', function() {
    it('should validate string constraints', function(done) {
      const validator = mod.createValidator()
      const schema = type({
